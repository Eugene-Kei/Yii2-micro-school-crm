...
class Pay extends \yii\db\ActiveRecord {
    ...
    public function scenarios() {
        return [
            'pay-create' => ['user_id', 'startdate', 'ticket_id', 'cash',
                'bonus_cash', 'comment', 'groups', 'startdate'],
            'pay-edit'   => ['residual']
        ];
    }
